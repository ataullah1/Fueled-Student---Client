...
const MealsSkeleton = () => {
  return (
    <div className="flex flex-col md:flex-row rounded-md p-3 bg-white gap-1 md:h-52">
      <div className="w-full md:w-1/4 h-52 sm:h-64 md:h-auto rounded-md">
        <Skeleton className="w-full h-full rounded-t-md md:rounded-tr-none md:rounded-l-md " />
      </div>
